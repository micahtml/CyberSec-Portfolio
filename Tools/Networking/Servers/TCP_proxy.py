...
# Clients establish connections to the TCP proxy server, which then establishes a connection
...
def main():
    ...
    # Add a signal handler for keyboard interrupt
